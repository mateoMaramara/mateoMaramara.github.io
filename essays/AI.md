...
- **E12**: The Jamba Juice WODs were difficult for me the first time. Because of this, I did it exactly as recommended in the “Standard WOD Caveats” section, opting not to use AI and referencing the demonstration video instead.
...
- **E20**: I used GitHub Copilot for this WOD because I could not get a working solution without it. It was helpful, but after turning in the assignment I repeated it until I could do it unassisted.
...
Since AI tools were allowed, I tried to use them for essays. However, it was not much help, since AI’s ideas were so different from mine. For example, the essay on design patterns was difficult to do on my own. That is why I used AI tools to teach me, and I made my own metaphors and examples to the best of my ability.
...
This was primarily how I debugged my code if I ran into errors. I found it much faster than using Stack Overflow.
